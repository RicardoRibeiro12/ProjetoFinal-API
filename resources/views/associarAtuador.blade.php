...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="container">        
        <div class="container-fluid">
            <h1 class="mt-2"> Associar Atuador - Cultura 1</h1>
            <div class="row mt-5">
                <div class="col-sm-5">
                ...
                <div class="col-sm-2 mt-5">
                    <button type="button" id="multiselect_rightSelected" class="btn btn-block btn-cultura">Adicionar</button>
                    <button type="button" id="multiselect_leftSelected" class="btn btn-block btn-cultura">Retirar</button>
                </div>
            ...
            <div class="row mt-2">
                <div class="col text-center">
                  <button class="btn btn-lg btn-cultura text-uppercase fw-bold mb-5"
                          type="submit">Associar</button>
                </div>
              </div>
        </div>
    </div>
